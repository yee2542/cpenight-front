<template>
  <div id="register1">
    <div
      class="row"
      style="min-height: 100vh; display: grid; grid-template-columns: 50% 50%"
    >
      <div id="left-side">
      ...
      <div style="background: #282667; padding-top: 50px">
        ...
        <div id="right-side" class="column">
          <div>
            <h1 style="margin-top: 140px" class="title">REGISTER</h1>
            ...
            <p
              style="
                ...
                margin-top: 20px;
                margin-bottom: 20px;
                font: normal normal 300 20px/27px Cloud;
            ...
            <a id="regisButton" @click="onClick">Sign up with Email</a>
